...
$user_name = 'Danila Antufyev'; // укажите здесь ваше имя
...
$lots = array(
    array('name'=>'2014 Rossignol District Snowboard','item_class'=>'boards','price'=>10999,'url'=>'img/lot-1.jpg'),
    array('name'=>'DC Ply Mens 2016/2017 Snowboard','item_class'=>'boards','price'=>159999,'url'=>'img/lot-2.jpg'),
    array('name'=>'Union Contact Pro 2015 года размер L/XL','item_class'=>'attachment','price'=>8000,'url'=>'img/lot-3.jpg'),
    array('name'=>'DC Mutiny Charocal','item_class'=>'boots','price'=>10999,'url'=>'img/lot-4.jpg'),
    array('name'=>'Куртка для сноуборда DC Mutiny Charocal','item_class'=>'clothing','price'=>7500,'url'=>'img/lot-5.jpg'),
    array('name'=>'Маска Oakley Canopy','item_class'=>'other','price'=>5400,'url'=>'img/lot-6.jpg')
);
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <?php
	if ($is_auth == 1) { // Если пользователь авторизован
    		echo '<div class="user-menu__logged"><p>'. $user_name .'</p><a class="user-menu__bets" href="pages/my-bets.html">Мои ставки</a><a class="user-menu__logout" href="#">Выход</a></div>';
	} else { // Если пользователь не авторизован
    	echo '<ul class="user-menu__list"><li class="user-menu__item"><a href="#">Регистрация</a></li><li class="user-menu__item"><a href="#">Вход</a></li></ul>';
	}
	?>
...
<main class="container">
    ...
    <?php foreach($lots as $lot): ?>
        <li class="lots__item lot">
            ...
            <div class="lot__info">
                <span class="lot__category"><?= $categories[$lot['item_class']]; ?></span>
                <h3 class="lot__title"><a class="text-link" href="#"><?= $lot['name']; ?></a></h3>
                <div class="lot__state">
                    <div class="lot__rate">
                        <span class="lot__amount"><?= formatSum($lot['price']); ?><b class="rub">₽</b></span>
                    </div>
